    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-4 md:px-8 py-8 md:py-12 space-y-10">
        ...
        <section className="rounded-[24px] bg-[linear-gradient(135deg,#0f172a_0%,#1e3a8a_100%)] p-6 md:p-8">
          ...
          <div className="flex flex-wrap gap-2">
            <Link href="/calc/tesla-subsidy" className="inline-flex items-center gap-1.5 rounded-xl bg-white text-slate-950 px-4 py-2 text-xs font-bold hover:bg-blue-50 transition-colors">
              테슬라 보조금 계산기
            </Link>
