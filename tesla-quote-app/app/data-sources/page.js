...
const SECTIONS = [
  {
    ...
    rows: [
      ...
      { item: "확인 주기", value: "테슬라 공식 가격 변경 시 수시 확인" },
  ...
  },
  {
    ...
    rows: [
      ...
      { item: "지방 보조금", value: "각 지자체 전기차 보급사업 공고 기준 (17개 시·도)" },
      { item: "데이터 기준일", value: CALC_DATA_DATE },
      { item: "확인 주기", value: "연초 공고 + 변경·추경 공고 발표 시 수시 확인" },
      {
        item: "주의사항",
        value:
          "보조금은 예산 소진·정책 변경으로 시기에 따라 달라질 수 있습니다. 신청 전 해당 지자체에서 최신 금액을 확인하세요.",
      },
    ],
  },
  {
    ...
    rows: [
      {
        item: "성격",
        value: "추정값 — 충전 장소·멤버십·계절·사업자 요금에 따라 달라집니다",
      },
      {
        item: "완속 단가",
        value: `${CALC_DEFAULTS.slowPrice.toLocaleString("ko-KR")}원/kWh — 가정용·공용 완속 평균 가정`,
      },
      {
        item: "급속 단가",
        value: `${CALC_DEFAULTS.fastPrice.toLocaleString("ko-KR")}원/kWh — 공공 급속 평균 가정`,
      },
      {
        item: "전비",
      ...
      { item: "데이터 기준일", value: CALC_DATA_DATE },
      { item: "확인 주기", value: "한국전력 충전 요금표 변경 시 확인" },
      {
        item: "출처",
  ...
  {
    title: "보험료·자동차세 (보험료는 추정값)",
    rows: [
      {
        item: "성격",
        value: "보험료는 추정값 — 나이·운전경력·사고이력·담보·개인/법인(사업자)에 따라 크게 달라집니다",
      },
      {
        item: "연 보험료",
      ...
      { item: "데이터 기준일", value: CALC_DATA_DATE },
      { item: "확인 주기", value: "자동차세 정책 변동 시 확인 / 보험료는 견적 시점마다 확인" },
      {
        item: "주의사항",
        value: "실제 보험료는 보험사 다이렉트 견적을 통해 확인하세요.",
      },
    ],
  },
  {
    ...
    rows: [
      {
        item: "성격",
        value: "추정값 — 사용자가 직접 입력하는 값. 실제 금리는 금융사·신용도·개인/사업자 조건에 따라 달라집니다",
      },
      {
        item: "기본 가정",
        value: "고정값 없음 — 딜러·금융사가 제시한 실제 금리를 입력해 계산하세요",
      },
      { item: "출처", value: "금융사별 상이 — 공식 견적 기준" },
      { item: "확인 주기", value: "견적 시점마다 확인" },
    ],
  },
  {
    title: "총소유비용(TCO) (추정값)",
    rows: [
      {
        item: "성격",
        value: "추정값 — 주행거리·중고 시세·개인 조건에 따라 달라집니다",
      },
      {
        item: "포함 항목",
      ...
      { item: "데이터 기준일", value: CALC_DATA_DATE },
      { item: "확인 주기", value: "차량 가격·중고 시세 변동 시 검토" },
    ],
  },
];
      ...
      <div className="mx-auto max-w-3xl px-4 md:px-8">
        <header className="mb-10">
          ...
          <p className="mt-3 text-sm md:text-base leading-7 text-slate-600">
            ...
            특히 <strong>충전비·보험료·할부 금리</strong>는 개인 조건 및 사업자 요금에 따라
            달라지는 추정값이며, 차량 가격·보조금도 시기에 따라 변동될 수 있습니다.
            최종 구매 전 딜러·금융사·지자체에서 실제 조건을 확인하세요.
          </p>
        </header>
