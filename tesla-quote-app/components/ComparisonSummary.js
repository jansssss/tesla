      ...
      <div className="bg-gradient-to-br from-gray-900 to-black p-5 md:p-5">
        ...
        <div className="mb-5 grid gap-4 md:grid-cols-2 md:gap-5">
          ...
          <div className="rounded-lg bg-white/5 p-4">
            ...
            <dl className="space-y-2 text-sm md:text-sm">
        ...
        <div className="mb-5 space-y-3">
          ...
          <div className="rounded-lg bg-white/5 p-4">
            <p className="mb-1 text-sm font-medium text-gray-400 md:text-sm">📊 월 납입금 차액</p>
        ...
        {isPricierB && priceDiff > 0 && (
          <div className="border-t border-white/20 pt-5 md:pt-6">
            ...
            <p className="mb-4 text-sm leading-relaxed text-gray-300 md:text-sm">
            ...
            <div className="space-y-3">
              ...
              {strategy1.feasible && (
                <div className="rounded-lg bg-white/10 p-3 md:p-4">
                  <p className="mb-2 text-sm font-bold text-gray-300 md:text-sm">방법 1: 선금 추가</p>
              ...
              {strategy2.feasible && (
                <div className="rounded-lg bg-white/10 p-3 md:p-4">
                  <p className="mb-2 text-sm font-bold text-gray-300 md:text-sm">방법 2: 할부 연장</p>
                  <p className="text-sm leading-relaxed md:text-sm">
              ...
              {strategy3.feasible && (
                <div className="rounded-lg bg-white/10 p-3 md:p-4">
                  <p className="mb-2 text-sm font-bold text-gray-300 md:text-sm">방법 3: 절충안</p>
                  <p className="text-sm leading-relaxed md:text-sm">
